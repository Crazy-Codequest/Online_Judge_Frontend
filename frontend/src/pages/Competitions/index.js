            ...
            >
              <Box sx={{ position: "absolute", top: 16, left: 16, zIndex: 2 }}>
                <Typography
                  ...
                  sx={{
                    ...
                    py: 0.5,
                    borderRadius: 2,
                    bgcolor: status.color === "success" ? "#e8f5e9" : status.color === "info" ? "#e3f2fd" : "#ececec",
                    color: status.color === "success" ? "#388e3c" : status.color === "info" ? "#1976d2" : "#7b8ba3",
                    fontWeight: 700,
                  }}
                >
                  {status.label}
              ...
              <CardContent sx={{ p: 2 }}>
                ...
                <Typography variant="body2" color="#7b8ba3">
                  📅 Start: <strong>{getFormattedDateTime(competition.start_date)}</strong>
                </Typography>
                <Typography variant="body2" color="#7b8ba3" mb={1}>
                  🏁 End: <strong>{getFormattedDateTime(competition.end_date)}</strong>
                </Typography>
              ...
              <CardActions sx={{ px: 2, pb: 2 }}>
                <Button
                  ...
                  title={foundUser(competition) ? "You are registered for this competition" : "Register to participate"}
